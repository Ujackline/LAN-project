% Function to simulate two series link network
...
% Function to calculate theoretical result for two series links
function result = calculateTheoreticalTwoLinks(K, p)
    result = K * (1 / (1-p)^2);
end